...
public class Slider_list_activity extends AppCompatActivity implements Slider_list_adapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slider_list);
    ...
    private void load_data(String status) {
        ...
        apiService.getSlider(secret_id, api_token, status).enqueue(new Callback<Slider_list_response>() {
            @Override
            public void onResponse(Call<Slider_list_response> call, Response<Slider_list_response> response) {
                if (response.body().getE() == 0 && response.body().getM().size() != 0) {
                    ...
                    adapter.setOnClickListener(Slider_list_activity.this::OnItemClick);
    ...
    public void OnItemClick(int position) {
        ...
        apiService.updateSlider(secret_id, api_token, sliderID).enqueue(new Callback<SorkariResponse>() {
            @Override
