...
public class Free_fire_full_map_main_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_fire_match);
        ...
        addRulesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //startActivity(new Intent(getApplicationContext(), FreeFireRegularRulesActivity.class));
    ...
    private void set_title() {
        ...
        } else if (gameTypeID.equals("6")) {
            nameText.setText("Daily Scrims");
        } else if (gameTypeID.equals("7")) {
            nameText.setText("Ludo (Quick)");
        } else if (gameTypeID.equals("8")) {
            nameText.setText("Ludo (4 Player)");
        } else if (gameTypeID.equals("9")) {
            nameText.setText("Free Fire(Premium)");
        } else if (gameTypeID.equals("10")) {
    ...
    private void add_new_match() {
        ...
        Dialog addMatchDialog = new Dialog(Free_fire_full_map_main_activity.this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAllFileds()) {
                    ...
                    /*Log.d("dataxx", oneState.toString() + " " + twoState.toString() + " " + threeState.toString() +
                            " " + fourState.toString() + " " + fiveState.toString() + " " + sixState.toString() + " " + sevenState.toString() +
                            " " + eightState.toString() + " " + nineState.toString() + " " + tenState.toString());*/
        ...
        mTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog tpd = new TimePickerDialog(Free_fire_full_map_main_activity.this, (view1, hourOfDay, minute) -> {
                ...
                }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DateFormat.is24HourFormat(Free_fire_full_map_main_activity.this));
                tpd.show();
        ...
        mDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(Free_fire_full_map_main_activity.this, (view1, year, month, dayOfMonth) -> {
    ...
    private void init_view() {
        ...
        loader = new Dialog(Free_fire_full_map_main_activity.this);
