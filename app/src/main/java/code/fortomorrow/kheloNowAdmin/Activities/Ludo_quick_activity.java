...
public class Ludo_quick_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ludo_quick);
    ...
    private void add_ludo_match_function() {
        Dialog addMatchDialog = new Dialog(Ludo_quick_activity.this);
        ...
        ludoDateButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(Ludo_quick_activity.this, (view1, year, month, dayOfMonth) -> {
        ...
        ludoTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog tpd = new TimePickerDialog(Ludo_quick_activity.this, (view1, hourOfDay, minute) -> {
                ...
                }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DateFormat.is24HourFormat(Ludo_quick_activity.this));
                tpd.show();
            }
        });
    ...
    private void auto_match_add() {
        Dialog addAutoMatchDialog = new Dialog(Ludo_quick_activity.this);
    ...
    private void init_view() {
        ...
        loader = new Dialog(Ludo_quick_activity.this);
