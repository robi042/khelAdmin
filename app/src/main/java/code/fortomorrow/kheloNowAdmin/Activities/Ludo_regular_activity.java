...
public class Ludo_regular_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loader = new Dialog(Ludo_regular_activity.this);
    ...
    private void auto_match_add() {
        Dialog addAutoMatchDialog = new Dialog(Ludo_regular_activity.this);
        ...
        ludoDateButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(Ludo_regular_activity.this, (view1, year, month, dayOfMonth) -> {
        ...
        ludoTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog tpd = new TimePickerDialog(Ludo_regular_activity.this, (view1, hourOfDay, minute) -> {
                ...
                }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DateFormat.is24HourFormat(Ludo_regular_activity.this));
                tpd.show();
            }
        });
    ...
    private void add_ludo_match_function() {
        Dialog addMatchDialog = new Dialog(Ludo_regular_activity.this);
