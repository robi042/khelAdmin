...
public class Daily_scrims_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_scrims);
        ...
        addRulesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Daily_scrims_add_rules_activity.class));
            }
        });
    }
    ...
    private void init_view() {
        ...
        loader = new Dialog(Daily_scrims_activity.this);
    ...
    private void add_new_match() {
        Dialog addMatchDialog = new Dialog(Daily_scrims_activity.this);
        ...
        mTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog tpd = new TimePickerDialog(Daily_scrims_activity.this, (view1, hourOfDay, minute) -> {
                ...
                }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DateFormat.is24HourFormat(Daily_scrims_activity.this));
                tpd.show();
        ...
        mDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(Daily_scrims_activity.this, (view1, year, month, dayOfMonth) -> {
