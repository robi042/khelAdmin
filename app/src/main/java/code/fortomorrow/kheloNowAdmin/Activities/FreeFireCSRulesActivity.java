...
public class FreeFireCSRulesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_fire_cs_rules);
        mAdd = findViewById(R.id.mAdd);
        mRules = findViewById(R.id.mRules);
        ...
        Toast.makeText(getApplicationContext(), gameID, Toast.LENGTH_SHORT).show();

        mAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                apiService.updateRules(secret_id, api_token, mRules.getText().toString()).enqueue(new Callback<SorkariResponse>() {
                    @Override
        ...
        apiService.getRules(secret_id, api_token).enqueue(new Callback<RulesResponse>() {
            @Override
