...
public class Ludo_four_player_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ludo_four_player);
    ...
    private void auto_match_add() {
        Dialog addAutoMatchDialog = new Dialog(Ludo_four_player_activity.this);
        ...
        ludoDateButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(Ludo_four_player_activity.this, (view1, year, month, dayOfMonth) -> {
        ...
        ludoTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog tpd = new TimePickerDialog(Ludo_four_player_activity.this, (view1, hourOfDay, minute) -> {
                ...
                }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), DateFormat.is24HourFormat(Ludo_four_player_activity.this));
                tpd.show();
            }
        });
    ...
    private void add_ludo_match_function() {
        Dialog addMatchDialog = new Dialog(Ludo_four_player_activity.this);
        ...
        ludoSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(ludoDate) || TextUtils.isEmpty(ludoTime) || TextUtils.isEmpty(ludoTitle) || TextUtils.isEmpty(ludoEntryFee) || TextUtils.isEmpty(ludoTotalPlayer) || TextUtils.isEmpty(ludoPrize) || TextUtils.isEmpty(ludoType) || TextUtils.isEmpty(ludoGameType)) {
                    ...
                    loader.show();
                    //Toast.makeText(getApplicationContext(), gameTypeID, Toast.LENGTH_SHORT).show();
                    apiService.getLudoAddMatchResponse(secret_id, api_token, ludoDate, ludoTime, ludoTitle, ludoEntryFee, ludoTotalPlayer, ludoPrize, ludoGameType, gameTypeID).enqueue(new Callback<AddNewMatchResponse>() {
                        @Override
                        public void onResponse(Call<AddNewMatchResponse> call, Response<AddNewMatchResponse> response) {
                            loader.dismiss();
                            //dialog1.dismiss();
    ...
    private void init_view() {
        ...
        loader = new Dialog(Ludo_four_player_activity.this);
