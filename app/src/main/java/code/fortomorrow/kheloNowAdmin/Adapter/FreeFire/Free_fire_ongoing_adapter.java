...
public class Free_fire_ongoing_adapter extends RecyclerView.Adapter<Free_fire_ongoing_adapter.ViewHolder> {
    private Context context;
    private List<M> ongoingList;
    private OnGoingActivity onGoingActivity;

    public Free_fire_ongoing_adapter(OnGoingActivity onGoingActivity, Context context, List<M> ongoingList) {
    ...
    @NonNull
    @Override
    public Free_fire_ongoing_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.free_fire_ongoing_match_list_layer, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Free_fire_ongoing_adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.ongoingByText.setText("Ongoing By "+ongoingList.get(position).ongoing_by);
        ...
        holder.mLayer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onGoingActivity.movetoResult(ongoingList.get(position).getMatchId(), ongoingList.get(position).getNote());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView noteText, ongoingByText;
