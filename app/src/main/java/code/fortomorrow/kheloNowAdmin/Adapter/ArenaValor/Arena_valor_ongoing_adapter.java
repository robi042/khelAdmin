...
public class Arena_valor_ongoing_adapter extends RecyclerView.Adapter<Arena_valor_ongoing_adapter.ViewHolder> {
    private List<Arena_valor_response.M> arenaValorOngoingList;

    public Arena_valor_ongoing_adapter(List<Arena_valor_response.M> arenaValorOngoingList) {
        this.arenaValorOngoingList = arenaValorOngoingList;
    }

    @NonNull
    @Override
    public Arena_valor_ongoing_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.arena_valor_ongoing_card, parent, false);
        return new Arena_valor_ongoing_adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Arena_valor_ongoing_adapter.ViewHolder holder, int position) {
    ...
    public void setOnClickListener(Arena_valor_ongoing_adapter.OnArenaValorItemClickListener onArenaValorItemClickListener) {
